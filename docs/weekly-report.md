...
- 포함된 체크포인트를 업무 항목별로 묶어 결과와 요약을 만든다.
- `evidence.commits`, `evidence.pull_requests`, `git` 기준점을 Git 변경으로 자동 집계한다.
- `verifications`의 테스트·빌드·lint·수동 확인 등을 상태와 명령 단위로 자동 집계한다.
